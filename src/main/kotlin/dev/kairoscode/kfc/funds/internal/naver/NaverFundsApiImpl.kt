package dev.kairoscode.kfc.funds.internal.naver

import dev.kairoscode.kfc.funds.internal.naver.NaverFundsApi
...
import dev.kairoscode.kfc.funds.internal.naver.model.NaverOhlcv
...
internal class NaverFundsApiImpl(
     ...
     * @return OHLCV 데이터 목록
     */
    private fun parseXmlResponse(xml: String): List<NaverOhlcv> {
        return try {
            ...
            val result = mutableListOf<NaverOhlcv>()
     ...
     * @return NaverOhlcv 객체
     */
    private fun parseDataField(data: String): NaverOhlcv {
