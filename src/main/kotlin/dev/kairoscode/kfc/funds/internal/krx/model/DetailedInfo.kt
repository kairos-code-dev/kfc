...
import dev.kairoscode.kfc.funds.internal.krx.KrxApiFields
import dev.kairoscode.kfc.util.*
import java.math.BigDecimal
import java.time.LocalDate

/**
 * MDCSTAT04701 - 펀드 상세정보 (시간 의존 데이터)
 *
 * 펀드의 주요 거래 정보를 단일 요청으로 제공하는 상세 데이터 모델입니다.
...
data class DetailedInfo(
    ...
    companion object {
        /**
         * KRX API 원시 응답으로부터 DetailedInfo 생성
         *
