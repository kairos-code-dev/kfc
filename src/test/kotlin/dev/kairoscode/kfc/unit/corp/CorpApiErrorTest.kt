...
class CorpApiErrorTest : UnitTestBase() {
    ...
    inner class FakeConfigurationErrors {
        ...
        fun `getCorpCodeList throws IllegalArgumentException when response is not configured`() =
            unitTest {
        ...
        fun `getDividendInfo throws IllegalArgumentException when response is not configured`() =
            unitTest {
        ...
        fun `getStockSplitInfo throws IllegalArgumentException when response is not configured`() =
            unitTest {
        ...
        fun `searchDisclosures throws IllegalArgumentException when response is not configured`() =
            unitTest {
    ...
    inner class ParsingErrors {
        ...
        fun `getCorpCodeList returns empty list on empty array response`() =
            unitTest {
                // Given: 빈 JSON 배열 응답
                fakeCorpApi =
                    FakeCorpApi(
        ...
        fun `getDividendInfo returns empty list on empty array response`() =
            unitTest {
                // Given: 빈 JSON 배열 응답
                fakeCorpApi =
                    FakeCorpApi(
        ...
        fun `getStockSplitInfo returns empty list on empty array response`() =
            unitTest {
                // Given: 빈 JSON 배열 응답
                fakeCorpApi =
                    FakeCorpApi(
        ...
        fun `searchDisclosures returns empty list on empty array response`() =
            unitTest {
                // Given: 빈 JSON 배열 응답
                fakeCorpApi =
                    FakeCorpApi(
    ...
    inner class NullCorpApi {
        ...
        fun `throws NullPointerException when CorpApi is null`() =
            unitTest {
                // Given: CorpApi를 설정하지 않음 (fakeFundsApi만 설정)
                fakeFundsApi =
                    object : dev.kairoscode.kfc.api.FundsApi {
