...
class FinancialsApiErrorTest : UnitTestBase() {
    ...
    inner class FakeConfigurationErrors {
        ...
        fun `getIncomeStatement throws IllegalArgumentException when response is not configured`() =
            unitTest {
        ...
        fun `getBalanceSheet throws IllegalArgumentException when response is not configured`() =
            unitTest {
        ...
        fun `getCashFlowStatement throws IllegalArgumentException when response is not configured`() =
            unitTest {
        ...
        fun `getAllFinancials throws IllegalArgumentException when response is not configured`() =
            unitTest {
    ...
    inner class NullFinancialsApi {
        ...
        fun `throws NullPointerException when FinancialsApi is null`() =
            unitTest {
