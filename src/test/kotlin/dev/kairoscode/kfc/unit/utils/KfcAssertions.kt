...
object KfcAssertions {
     ...
     * ETF 목록이 유효한지 검증합니다.
     */
    fun assertValidEtfList(
        etfList: List<FundListItem>,
        context: String = "",
    ) {
        assertThat(etfList)
     ...
     */
    fun assertValidPortfolio(
        portfolio: List<PortfolioConstituent>,
        context: String = "",
    ) {
