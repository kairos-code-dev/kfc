...
class FundsApiErrorTest : UnitTestBase() {
    ...
    inner class FakeConfigurationErrors {
        ...
        fun `throws IllegalArgumentException when response is not configured`() = unitTest {
        ...
        fun `getDetailedInfo throws exception when response is not configured`() = unitTest {
        ...
        fun `getPortfolio throws exception when response is not configured`() = unitTest {
        ...
        fun `getTrackingError throws exception when response is not configured`() = unitTest {
            ...
            // When & Then: API 호출 시 예외 발생
            val exception = assertThrows<IllegalArgumentException> {
                val fromDate = java.time.LocalDate.now().minusDays(7)
        ...
        fun `getDivergenceRate throws exception when response is not configured`() = unitTest {
        ...
        fun `getInvestorTrading throws exception when response is not configured`() = unitTest {
        ...
        fun `getShortSelling throws exception when response is not configured`() = unitTest {
        ...
        fun `getShortBalance throws exception when response is not configured`() = unitTest {
    ...
    inner class ParsingErrors {
        ...
        fun `returns empty list on empty array response`() = unitTest {
            // Given: 빈 JSON 배열 응답
            fakeFundsApi = FakeFundsApi(
                listResponse = "[]"
            )
        ...
        fun `getPortfolio returns empty list on empty array response`() = unitTest {
            // Given: 빈 JSON 배열 응답
            fakeFundsApi = FakeFundsApi(
                portfolioResponse = "[]"
            )
        ...
        fun `getTrackingError returns empty list on empty array response`() = unitTest {
            // Given: 빈 JSON 배열 응답
            fakeFundsApi = FakeFundsApi(
        ...
        fun `getDivergenceRate returns empty list on empty array response`() = unitTest {
            // Given: 빈 JSON 배열 응답
            fakeFundsApi = FakeFundsApi(
    ...
    inner class UnsupportedOperations {
        ...
        fun `getGeneralInfo throws UnsupportedOperationException`() = unitTest {
            // Given: Fake API
            fakeFundsApi = FakeFundsApi()
            initClient()
        ...
        fun `getPortfolioTop10 throws UnsupportedOperationException`() = unitTest {
            // Given: Fake API
            fakeFundsApi = FakeFundsApi()
            initClient()
        ...
        fun `getAllInvestorTradingByPeriod throws UnsupportedOperationException`() = unitTest {
            // Given: Fake API
            fakeFundsApi = FakeFundsApi()
            initClient()
        ...
        fun `getInvestorTradingByPeriod throws UnsupportedOperationException`() = unitTest {
            // Given: Fake API
            fakeFundsApi = FakeFundsApi()
            initClient()
