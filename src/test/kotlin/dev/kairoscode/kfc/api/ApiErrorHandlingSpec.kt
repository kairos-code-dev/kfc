...
class ApiErrorHandlingSpec : UnitTestBase() {

    private fun createDummyKrxEtfApi() = object : dev.kairoscode.kfc.api.krx.KrxEtfApi {
        override suspend fun getEtfList() = emptyList<EtfListItem>()
        override suspend fun getComprehensiveEtfInfo(isin: String, tradeDate: LocalDate) = null
        ...
        override suspend fun getEtfShortSelling(isin: String, fromDate: LocalDate, toDate: LocalDate) = emptyList<ShortSelling>()
        override suspend fun getEtfShortBalance(isin: String, fromDate: LocalDate, toDate: LocalDate) = emptyList<ShortBalance>()
    }

    private fun createDummyNaverEtfApi() = object : dev.kairoscode.kfc.api.naver.NaverEtfApi {
    ...
    fun `should throw exception for invalid ISIN format - too short`() = unitTest {
        // Given
        mockEtfApi = EtfApiImpl(createDummyKrxEtfApi(), createDummyNaverEtfApi())
        initClient()

        // When & Then
        var exception: KfcException? = null
        try {
            client.etf.getComprehensiveInfo("123", LocalDate.now())
    ...
    fun `should throw exception for invalid ISIN format - wrong prefix`() = unitTest {
        ...
        var exception: KfcException? = null
        try {
            client.etf.getComprehensiveInfo("US0000000000", LocalDate.now())
        } catch (e: KfcException) {
            exception = e
        }
    ...
    fun `should throw exception for invalid ISIN format - non-numeric`() = unitTest {
        ...
        var exception: KfcException? = null
        try {
            client.etf.getComprehensiveInfo("KR7@@@@@@@@@@@", LocalDate.now())
        } catch (e: KfcException) {
            exception = e
        }
    ...
    fun `should throw exception for blank ISIN`() = unitTest {
        ...
        var exception: KfcException? = null
        try {
            client.etf.getComprehensiveInfo("   ", LocalDate.now())
        } catch (e: KfcException) {
            exception = e
        }
    ...
    fun `should throw exception when fromDate is after toDate`() = unitTest {
        ...
        var exception: KfcException? = null
        try {
            client.etf.getOhlcv("KR7152100004", fromDate, toDate)
        } catch (e: KfcException) {
            exception = e
        }
    ...
    fun `should throw exception for future date`() = unitTest {
        ...
        var exception: KfcException? = null
        try {
            client.etf.getOhlcv("KR7152100004", futureDate, futureDate)
        } catch (e: KfcException) {
            exception = e
        }
    ...
    fun `should throw exception for Naver API HTTP error`() = unitTest {
        // Given
        val errorNaverApi = object : dev.kairoscode.kfc.api.naver.NaverEtfApi {
        ...
        mockEtfApi = EtfApiImpl(createDummyKrxEtfApi(), errorNaverApi)
        initClient()

        // When & Then
        var exception: KfcException? = null
        try {
            client.etf.getAdjustedOhlcv("069500", LocalDate.of(2024, 1, 1), LocalDate.of(2024, 1, 31))
        } catch (e: KfcException) {
            exception = e
        }
