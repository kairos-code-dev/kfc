...
class MockFundsApi(
    ...
    override suspend fun getDetailedInfo(isin: String, tradeDate: LocalDate): EtfDetailedInfo? {
        require(comprehensiveResponse != null) { "comprehensiveResponse가 설정되지 않았습니다" }
        return gson.fromJson(comprehensiveResponse, EtfDetailedInfo::class.java)
    }

    override suspend fun getIntradayBars(isin: String, tradeDate: LocalDate): List<EtfIntradayBar> {
        throw NotImplementedError("Mock에서는 지원하지 않습니다")
    }

    override suspend fun getRecentDaily(isin: String, tradeDate: LocalDate): List<EtfRecentDaily> {
        throw NotImplementedError("Mock에서는 지원하지 않습니다")
    }

    override suspend fun getGeneralInfo(isin: String, tradeDate: LocalDate): EtfGeneralInfo? {
        throw NotImplementedError("Mock에서는 지원하지 않습니다")
    }
