    ...
    inner class IndividualStatementsApi {
        ...
        inner class GetIncomeStatement {
            ...
            inner class BasicOperations {
                ...
                fun get_consolidated_annual_income_statement() =
                    integrationTest {
                        ...
                        val incomeStatement =
                            client.financials!!.getIncomeStatement(
                                corpCode = corpCode,
                                year = year,
                ...
                fun get_quarterly_income_statement() =
                    integrationTest {
                ...
                fun get_separate_income_statement() =
                    integrationTest {
            ...
            inner class ResponseValidation {
                ...
                fun response_contains_line_items() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: lineItems")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun can_retrieve_major_accounts() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 주요 계정과목")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun line_items_contain_current_amount() =
                    integrationTest {
            ...
            inner class UsageExamples {
                ...
                fun calculate_revenue_growth_rate() =
                    integrationTest {
                ...
                fun calculate_operating_profit_margin() =
                    integrationTest {
                        println("\n📘 활용 예제: 영업이익률 계산")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun compare_consolidated_vs_separate() =
                    integrationTest {
                        ...
                        if (consolidatedRevenue != null && separateRevenue != null) {
                            ...
                            println()
                            println(
                                "📊 분석: 연결 재무제표가 별도 대비 ${"%.2f".format(
                                    diffPercent,
                                )}% ${if (diffPercent > 0) "높음" else "낮음"}",
                            )
        ...
        inner class GetBalanceSheet {
            ...
            inner class BasicOperations {
                ...
                fun get_consolidated_annual_balance_sheet() =
                    integrationTest {
                        println("\n📘 API: getBalanceSheet()")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                        ...
                        val balanceSheet =
                            client.financials!!.getBalanceSheet(
                                corpCode = corpCode,
                                year = year,
                                reportType = ReportType.ANNUAL,
                                statementType = StatementType.CONSOLIDATED,
                ...
                fun get_quarterly_balance_sheet() =
                    integrationTest {
                        println("\n📘 파라미터 테스트: reportType = Q1")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun get_separate_balance_sheet() =
                    integrationTest {
                        println("\n📘 파라미터 테스트: statementType = SEPARATE")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class ResponseValidation {
                ...
                fun accounting_equation_validation() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 회계등식")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        ...
        inner class GetCashFlowStatement {
            ...
            inner class BasicOperations {
                ...
                fun get_consolidated_annual_cash_flow_statement() =
                    integrationTest {
                        ...
                        val cashFlowStatement =
                            client.financials!!.getCashFlowStatement(
                                corpCode = corpCode,
                                year = year,
                                reportType = ReportType.ANNUAL,
                                statementType = StatementType.CONSOLIDATED,
                ...
                fun get_quarterly_cash_flow_statement() =
                    integrationTest {
                        println("\n📘 파라미터 테스트: reportType = Q1")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun get_separate_cash_flow_statement() =
                    integrationTest {
                        println("\n📘 파라미터 테스트: statementType = SEPARATE")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class ResponseValidation {
                ...
                fun can_retrieve_major_cash_flows() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 주요 계정과목")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                @Test
                @DisplayName("계정과목은 당기금액(currentPeriodAmount)을 포함한다")
                fun line_items_contain_current_period_amount() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: currentPeriodAmount")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class UsageExamples {
                ...
                fun analyze_cash_flow_pattern() =
                    integrationTest {
                        ...
                        if (operatingCashFlow != null && investingCashFlow != null && financingCashFlow != null) {
                            ...
                            println("📊 현금흐름 패턴:")
                            println(
                                "  • 영업활동: ${if (operatingCashFlow > java.math.BigDecimal.ZERO) "유입 +" else "유출 -"}",
                            )
                            println(
                                "  • 투자활동: ${if (investingCashFlow > java.math.BigDecimal.ZERO) "유입 +" else "유출 -"}",
                            )
                            println(
                                "  • 재무활동: ${if (financingCashFlow > java.math.BigDecimal.ZERO) "유입 +" else "유출 -"}",
                            )
                ...
                fun analyze_cash_flow_trend() =
                    integrationTest {
                        ...
                        println()
                        println(
                            "📊 분석: ${if (growthRate > 0) "현금창출력 증가" else "현금창출력 감소"} (${"%.2f".format(growthRate)}%)",
                        )
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
                    }
                ...
                fun compare_consolidated_vs_separate_cash_flow() =
                    integrationTest {
    ...
    inner class CombinedStatementsApi {
        ...
        inner class GetAll {
            ...
            inner class BasicOperations {
                ...
                fun get_all_financial_statements() =
                    integrationTest {
                        ...
                        val financialStatements =
                            client.financials!!.getAllFinancials(
                                corpCode = corpCode,
                                year = year,
                                reportType = ReportType.ANNUAL,
                                statementType = StatementType.CONSOLIDATED,
                        ...
                        println(
                            "  • cashFlowStatement: ${financialStatements.cashFlowStatement?.lineItems?.size ?: 0}개 항목",
                        )
                ...
                fun get_quarterly_all_financials() =
                    integrationTest {
                        println("\n📘 파라미터 테스트: reportType = Q1")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class ResponseValidation {
                ...
                fun response_contains_three_statements() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 3개 재무제표")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                        ...
                        println(
                            "  • cashFlowStatement: ${if (financialStatements.cashFlowStatement != null) "✓" else "✗"}",
                        )
                ...
                fun each_statement_contains_line_items() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 계정과목 데이터")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun can_retrieve_major_financial_indicators() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 주요 재무지표")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class EdgeCases {
                ...
                fun statements_have_consistent_metadata() =
                    integrationTest {
                        println("\n📘 엣지 케이스: 데이터 일관성 검증")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class UsageExamples {
                ...
                fun collect_data_for_financial_dashboard() =
                    integrationTest {
                        println("\n📘 실무 활용: 재무 분석 대시보드")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun batch_collect_multiple_years() =
                    integrationTest {
                ...
                fun download_and_save_all_financials() =
                    integrationTest {
                        println("\n📘 실무 활용: 재무제표 전체 다운로드")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
