    ...
    inner class BondYieldApi {
        ...
        inner class GetBondYieldsByDate {
            ...
            inner class BasicOperations {
                ...
                fun get_another_trading_day_bond_yields() =
                    integrationTest {
                        // Given: 이전 거래일
            ...
            inner class ResponseValidation {
                ...
                fun change_should_be_in_normal_range() =
                    integrationTest {
                        // Given
                        val date = TestFixtures.TRADING_DAY
                        println("\n📘 응답 검증: 변동폭 범위 확인")
                ...
                fun all_major_bond_types_included() =
                    integrationTest {
                        // Given
                        val date = TestFixtures.TRADING_DAY
                        println("\n📘 응답 검증: 주요 채권 포함 여부")
            ...
            inner class UsageExamples {
                ...
                fun calculate_term_spread() =
                    integrationTest {
                        ...
                        println(
                            "  • 의미: ${if (termSpread != null && termSpread > BigDecimal.ZERO) "정상 수익률 곡선" else "역전 가능성"}",
                        )
        ...
        inner class GetBondYields {
            ...
            inner class ResponseValidation {
                ...
                fun dates_should_be_sorted_ascending() =
                    integrationTest {
                        // Given
                ...
                fun all_dates_within_requested_period() =
                    integrationTest {
                        // Given
            ...
            inner class InputValidation {
                ...
                fun returns_empty_when_from_after_to() =
                    integrationTest {
                        // Given
            ...
            inner class UsageExamples {
                ...
                fun calculate_yield_volatility() =
                    integrationTest {
                        println("\n📘 실무 활용: 수익률 변동성 계산")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
