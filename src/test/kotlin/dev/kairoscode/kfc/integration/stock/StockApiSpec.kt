...
/**
 * [Stock] StockApi - 주식 종목 정보 API 통합 테스트
 *
 * KRX API를 사용한 주식 종목 정보 조회 기능을 검증합니다.
 * API 문서처럼 읽히도록 설계되었습니다.
 */
@DisplayName("[I][Stock] StockApi - 주식 종목 정보 API")
class StockApiSpec : IntegrationTestBase() {
    @Nested
    @DisplayName("종목 리스트 API")
    inner class StockListApi {
        @Nested
        ...
        inner class GetStockList {
            ...
            inner class ResponseValidation {
                ...
                fun ticker_length_is_six_digits() =
                    integrationTest {
                        // Given
                        println("\n📘 응답 검증: 종목 코드 형식")
                ...
                fun isin_length_is_twelve_digits() =
                    integrationTest {
                        // Given
                        println("\n📘 응답 검증: ISIN 형식")
                ...
                fun all_stocks_belong_to_requested_market() =
                    integrationTest {
                        // Given
                        println("\n📘 응답 검증: 시장 필터링")
            ...
            inner class UsageExamples {
                ...
                fun filter_samsung_group_stocks() =
                    integrationTest {
                        println("\n📘 실무 활용: 삼성 그룹 종목 필터링")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        ...
        inner class GetStockInfo {
            ...
            inner class BasicOperations {
                ...
                fun get_samsung_electronics_stock_info() =
                    integrationTest {
                        // Given
                        val ticker = "005930"
                        println("\n📘 API: getStockInfo()")
        ...
        inner class GetStockName {
            ...
            inner class InputValidation {
                @Test
                @DisplayName("존재하지 않는 종목 코드는 null을 반환한다")
                fun returns_null_for_invalid_ticker() =
                    integrationTest {
                        // Given
                        val invalidTicker = "999999"
                        println("\n📘 입력 검증: 존재하지 않는 종목 코드")
    ...
    @Nested
    @DisplayName("업종 분류 API")
    inner class SectorAndIndustryApi {
        @Nested
        ...
        inner class GetSectorClassifications {
            ...
            inner class BasicOperations {
                ...
                fun get_kospi_sector_classifications() =
                    integrationTest {
                        // Given
                        ...
                        // When
                        val sectors =
                            client.stock.getSectorClassifications(
                                date = date,
                                market = market,
                            )
                ...
                fun get_kosdaq_sector_classifications() =
                    integrationTest {
                        // Given
                        val date = LocalDate.now().minusDays(1)
        ...
        inner class GetIndustryGroups {
            ...
            inner class BasicOperations {
                ...
                fun get_industry_groups() =
                    integrationTest {
                        ...
                        // When
                        val industries =
                            client.stock.getIndustryGroups(
                                date = date,
                                market = market,
                            )
            ...
            inner class UsageExamples {
                ...
                fun analyze_top_industries_by_market_cap() =
                    integrationTest {
                        println("\n📘 실무 활용: 시가총액 상위 산업 분석")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    inner class SearchApi {
        ...
        inner class SearchStocks {
            ...
            inner class ParameterCombinations {
                ...
                fun compare_search_results_by_market() =
                    integrationTest {
                        println("\n📘 파라미터 조합: market")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class EdgeCases {
                ...
                fun returns_empty_for_non_existent_keyword() =
                    integrationTest {
                        // Given
            ...
            inner class UsageExamples {
                ...
                fun autocomplete_stock_search() =
                    integrationTest {
                        ...
                        val suggestions =
                            client.stock
                                .searchStocks(userInput, market = Market.ALL)
