    ...
    inner class DailyPriceApi {
        ...
        inner class GetRecentDaily {
            ...
            inner class BasicOperations {
                ...
                fun get_tiger200_recent_daily_on_trading_day() =
                    integrationTest {
                        println("\n📘 API: getRecentDaily()")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun get_kodex200_recent_daily_on_trading_day() =
                    integrationTest {
                        println("\n📘 API: getRecentDaily()")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun get_different_price_data_by_different_isin() =
                    integrationTest {
                        println("\n📘 파라미터 테스트: isin")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class ResponseValidation {
                ...
                fun response_list_size_is_between_1_and_10() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 리스트 크기")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun list_is_sorted_by_trade_date_descending() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 날짜 정렬")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class EdgeCases {
                ...
                fun returns_recent_trading_day_data_on_non_trading_day() =
                    integrationTest {
                        println("\n📘 엣지 케이스: 비거래일 조회")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class UsageExamples {
                ...
                fun calculate_recent_return_rate() =
                    integrationTest {
                        println("\n📘 활용 예제: 수익률 계산")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun analyze_recent_volume_trend() =
                    integrationTest {
                        println("\n📘 활용 예제: 거래량 추이 분석")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun analyze_recent_price_volatility() =
                    integrationTest {
                        println("\n📘 활용 예제: 가격 변동성 분석")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    inner class IntradayPriceApi {
        ...
        inner class GetIntraday {
            ...
            inner class BasicOperations {
                ...
                fun get_tiger200_intraday_bars() =
                    integrationTest {
                        println("\n📘 API: getIntradayBars()")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun get_kodex200_intraday_bars() =
                    integrationTest {
            ...
            inner class ResponseValidation {
                ...
                fun response_contains_ohlcv_data_when_available() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: OHLCV 구조")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun high_price_is_greater_or_equal_to_low_price() =
                    integrationTest {
                        println("\n📘 응답 데이터 검증: 가격 범위")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class EdgeCases {
                ...
                fun returns_empty_list_on_non_trading_day() =
                    integrationTest {
                        println("\n📘 엣지 케이스: 비거래일 조회")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun returns_empty_list_for_past_trading_day() =
                    integrationTest {
                        println("\n📘 엣지 케이스: 과거 거래일 조회")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class UsageExamples {
                ...
                fun analyze_intraday_volatility() =
                    integrationTest {
                        println("\n📘 활용 예제: 장중 변동성 분석")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun analyze_intraday_volume_trend() =
                    integrationTest {
                        println("\n📘 활용 예제: 분단위 거래량 분석")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun compare_open_and_close_prices() =
                    integrationTest {
                        println("\n📘 활용 예제: 장중 등락 분석")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
