...
/**
 * 법인 고유번호 목록 조회 Integration Test
 *
...
class CorpApiCodeSpec : IntegrationTestBase() {
    ...
    fun testGetCorpCodeList() = integrationTest(timeout = 2.minutes) {
        ...
        // Then: 삼성전자 포함 확인
        val samsung = corpCodeList.find { it.corpCode == TestFixtures.Corp.SAMSUNG_CORP_CODE }
    ...
    fun testFindCorpCodeByStockCode() = integrationTest(timeout = 2.minutes) {
        ...
        assertTrue(samsung!!.corpCode == TestFixtures.Corp.SAMSUNG_CORP_CODE, "올바른 corp_code를 반환해야 합니다")
