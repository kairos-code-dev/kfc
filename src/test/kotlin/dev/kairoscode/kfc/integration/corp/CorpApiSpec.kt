    ...
    inner class CorpCodeApi {
        ...
        inner class GetCorpCodeList {
            ...
            inner class BasicOperations {
                ...
                fun get_all_corp_code_list() =
                    integrationTest(timeout = 2.minutes) {
                        println("\n📘 API: getCorpCodeList()")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun auto_decompression_and_parsing() =
                    integrationTest(timeout = 2.minutes) {
            ...
            inner class ResponseValidation {
                ...
                fun returns_large_number_of_corp_codes() =
                    integrationTest(timeout = 2.minutes) {
                        println("\n📘 응답 데이터 검증: 데이터 볼륨")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun all_corps_have_valid_fields() =
                    integrationTest(timeout = 2.minutes) {
                ...
                fun contains_samsung_electronics() =
                    integrationTest(timeout = 2.minutes) {
                        println("\n📘 응답 데이터 검증: 특정 법인 존재")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            ...
            inner class EdgeCases {
                ...
                fun includes_both_listed_and_unlisted() =
                    integrationTest(timeout = 2.minutes) {
                        println("\n📘 엣지 케이스: 상장/비상장 모두 포함")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun processes_large_data_within_timeout() =
                    integrationTest(timeout = 2.minutes) {
            ...
            inner class UsageExamples {
                ...
                fun find_corp_by_stock_code_samsung() =
                    integrationTest(timeout = 2.minutes) {
                        println("\n📘 실무 활용: 종목코드로 검색")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun filter_kospi_listed_companies() =
                    integrationTest(timeout = 2.minutes) {
                        println("\n📘 실무 활용: 코스피 상장사 필터링")
                        println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun group_corps_by_stock_code_prefix() =
                    integrationTest(timeout = 2.minutes) {
                ...
                fun build_stock_code_to_corp_code_mapping() =
                    integrationTest(timeout = 2.minutes) {
    ...
    inner class DividendAndStockChangeApi {
        ...
        inner class GetDividendInfo {
            ...
            inner class BasicOperations {
                ...
                fun get_samsung_dividend_info_for_fixed_year() =
                    integrationTest {
                        requireOpendartApiKey()
                ...
                fun get_kakao_dividend_info_for_fixed_year() =
                    integrationTest {
                        requireOpendartApiKey()
            ...
            inner class EdgeCases {
                ...
                fun query_with_different_report_types() =
                    integrationTest {
                        requireOpendartApiKey()
            ...
            inner class UsageExamples {
                ...
                fun get_dividend_history_for_fixed_period() =
                    integrationTest {
                        requireOpendartApiKey()
        ...
        inner class GetStockSplitInfo {
            ...
            inner class BasicOperations {
                ...
                fun get_samsung_stock_split_info_for_fixed_year() =
                    integrationTest {
                        requireOpendartApiKey()
                ...
                fun get_kakao_stock_split_info_for_fixed_year() =
                    integrationTest {
                        requireOpendartApiKey()
            ...
            inner class EdgeCases {
                ...
                fun return_empty_result_when_no_stock_split() =
                    integrationTest {
                        requireOpendartApiKey()
            ...
            inner class UsageExamples {
                ...
                fun get_stock_split_history_for_fixed_period() =
                    integrationTest {
                        requireOpendartApiKey()
    ...
    inner class DisclosureApi {
        ...
        inner class SearchDisclosures {
            ...
            inner class BasicOperations {
                ...
                fun search_disclosures_for_specific_period() =
                    integrationTest {
                        requireOpendartApiKey()
            ...
            inner class EdgeCases {
                ...
                fun search_all_corp_disclosures() =
                    integrationTest {
                        requireOpendartApiKey()
                ...
                fun pagination_works_correctly() =
                    integrationTest {
                        requireOpendartApiKey()
            ...
            inner class UsageExamples {
                ...
                fun search_disclosures_by_keyword() =
                    integrationTest {
                        requireOpendartApiKey()
                ...
                fun analyze_disclosure_statistics() =
                    integrationTest {
                        requireOpendartApiKey()
