    ...
    inner class IndexListApi {
        ...
        inner class GetIndexList {
            ...
            inner class BasicOperations {
                ...
                fun get_kospi_index_list() = integrationTest {
                    // Given: Market = KOSPI
                    println("\n📘 API: getIndexList()")
                    println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                ...
                fun get_kosdaq_index_list() = integrationTest {
                    // Given: Market = KOSDAQ
                    println("\n📘 API: getIndexList()")
                    println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                    println("📥 Input Parameters:")
            ...
            inner class ResponseValidation {
                ...
                fun all_indexes_have_ticker_and_name() = integrationTest {
                    // Given
                    println("\n📘 응답 검증: 필수 필드 확인")
            ...
            inner class UsageExamples {
                ...
                fun filter_kospi200_indexes() = integrationTest {
        ...
        inner class GetIndexName {
            ...
            inner class BasicOperations {
                ...
                fun get_kospi_index_name() = integrationTest {
                    // Given
                    val ticker = "1001"
                    println("\n📘 API: getIndexName()")
                    println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    inner class IndexOhlcvApi {
        ...
        inner class GetOhlcvByDate {
            ...
            inner class UsageExamples {
                ...
                fun calculate_daily_returns() = integrationTest {
                    println("\n📘 실무 활용: 일별 수익률 계산")
                    println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    inner class IndexConstituentsApi {
        ...
        inner class GetIndexConstituents {
            ...
            inner class UsageExamples {
                ...
                fun check_samsung_in_kospi200() = integrationTest {
