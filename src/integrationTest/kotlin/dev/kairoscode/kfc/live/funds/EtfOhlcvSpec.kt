...
/**
 * ETF OHLCV 조회 Integration Test
 *
 * getOhlcv() 함수의 실제 API 호출 테스트 및 응답 레코딩
 */
class EtfOhlcvSpec : IntegrationTestBase() {

    @Test
    @DisplayName("1개월 OHLCV 데이터를 고정 기간으로 조회할 수 있다")
    fun testGetOhlcv1Month() = integrationTest {
        // Given: 고정 1개월 기간 설정
        ...
        // When: OHLCV 조회
        val ohlcvList = client.funds.getOhlcv(isin, fromDate, toDate)
    ...
    fun testGetOhlcv3Months() = integrationTest {
        // Given: 고정 3개월 기간 설정
        val toDate = TestSymbols.TRADING_DAY // 2024-11-25
    ...
    fun testGetOhlcv1Year() = integrationTest {
    ...
    fun testReturnCalculation() = integrationTest {
    ...
    fun testMovingAverageCalculation() = integrationTest {
        // Given: 고정 3개월 OHLCV 데이터
        val toDate = TestSymbols.TRADING_DAY // 2024-11-25
        val fromDate = TestSymbols.THREE_MONTHS_AGO // 2024-08-25
        val isin = TestSymbols.TIGER_200_ISIN
